package su.afk.cocktailrecipe.data.network.dto

// todo Попробовать избавиться от Any с помощью мапера
// загнав их в список listIngridient и просто проходиться по списку
